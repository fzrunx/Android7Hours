...
object MockTrail {
    ...
    init {
        with(recommendedPaths) {
            add(UserPath(1, "강남역 주변 산책로", "산책왕123", 1.5f, 15, 45, 0.3f, listOf(Coord(0.2, 0.3))))
            add(UserPath(2, "압구정 한강 야경 코스", "멍멍이사랑", 2.8f, 35, 89, 0.8f,  listOf(Coord(0.45, 0.6))))
            add(UserPath(3, "청담동 카페거리 산책", "댕댕이집사", 2.0f, 25, 67, 1.2f, listOf(Coord(0.3, 0.7))))
            add(UserPath(4, "선릉역 공원 코스", "산책매니아", 1.2f, 15, 34, 1.5f, listOf(Coord(0.55, 0.4))))
            add(UserPath(5, "서울숲 산책로", "자연러버", 2.5f, 30, 152, 2.1f,  listOf(Coord(0.25, 0.5))))
        }
